...
public final class products_update_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//        pc = HibernateSession.Load(s, ProductCategory.class, request.getParameter("update"));
//    }
    Product product = null;
    if (request.getParameter("update") != null) {
        product = HibernateSession.Load(s, Product.class, request.getParameter("update"));
    } else {
    ...
    if (product != null) {
        pr = product.getProductRequest();
    }

    List<String> sizeValues, colourValues;

    if (pr != null) {
        sizeValues = Arrays.asList(pr.getSize().split(","));
        colourValues = Arrays.asList(pr.getColour().split(","));
    } else {
    ...
    List<ProductColour> colo = c4.list();
      ...
      out.write("        <br>\n");
      out.write("        <br>\n");
      out.write("        <form action=\"../update_product\" method=\"POST\" enctype=\"multipart/form-data\">\n");
 ...
 for (ProductCategory pcat : pcl) {
      ...
      out.write('"');
      out.print(product.getProductCategory().getId() != null && product.getProductCategory().getId().equals(pcat.getId()) ? "selected" : "");
      out.write('>');
      ...
      out.write("                                        ");
                                            ...
                                            if (product != null) {
                                                ...
                                                c3.add(Restrictions.eq("productCategory", product.getProductCategory()));
      ...
      out.write('"');
      out.write(' ');
      out.print(product.getProductSubcategory().getId() != null && product.getProductSubcategory().getId().equals(c.getId()) ? "selected" : "");
      out.write('>');
      ...
      out.write("                                <div class=\"col-sm-4\">\n");
      out.write("                                    <input type=\"text\" class=\"form-control\" name=\"pname\" id=\"pname\" required=\"\" onkeypress=\"return isAlfa(event)\" value=\"");
 ...
 for (ProductColour colour : colo) {
      ...
      out.write('"');
      out.write(' ');
      out.print(product.getProductColour().getId() != null && product.getProductColour().getId().equals(colour.getId()) ? "selected" : "");
      out.write('>');
  ...
  for (ProductSize psize : psl) {
      ...
      out.write('"');
      out.write(' ');
      out.print(product.getProductSize().getId() != null && product.getProductSize().getId().equals(psize.getId()) ? "selected" : "");
      out.write('>');
      ...
      out.write("                                <div class=\"col-sm-4\"> \n");
      out.write("                                    <input type=\"number\" class=\"form-control\" name=\"pqty\" value=\"");
      ...
      out.write("\" type=\"text\" class=\"form-control\" placeholder=\"0.00\" name=\"pprice\" onkeypress=\"return isNumber(event)\"/>\n");
      ...
      out.write("                                <div class=\"col-sm-4\"> \n");
      out.write("                                    <input value=\"");
      out.print(product.getShipping());
      out.write("\" type=\"text\" class=\"form-control\" placeholder=\"0.00\" name=\"pshipping\" onkeypress=\"return isNumber(event)\"/>\n");
      ...
      out.write("                                        ");
                                            ...
                                            Set<ProductImage> pi = product.getProductImages();
                                            String i1 = null;
                                            String i2 = null;
                                            String i3 = null;
                                            for (ProductImage productimage : pi) {
                                                if (i1 == null) {
                                                    i1 = productimage.getUrl();
                                                } else if (i2 == null) {
                                                    i2 = productimage.getUrl();

                                                } else if (i3 == null) {
                                                    i3 = productimage.getUrl();
      ...
      out.write("                                        <img src=\"");
      out.print(i1);
      out.write("\" alt=\"imge\" width=\"220\" height=\"200\" id=\"img1\">\n");
      ...
      out.write("                                        <img src=\"");
      out.print(i2);
      out.write("\" alt=\"imge\" width=\"220\" height=\"200\" id=\"img2\">\n");
      ...
      out.write("                                        <img src=\"");
      out.print(i3);
      out.write("\" alt=\"imge\" width=\"220\" height=\"200\" id=\"img3\">\n");
      ...
      out.write("                                <div class=\"col-sm-4\">\n");
      out.write("                                    <textarea  id=\"textarea\" class=\"form-control\" rows=\"4\" name=\"rdescription\">");
      out.print(product.getProductRequest().getDescription());
      out.write("</textarea>\n");
      out.write("                                </div>\n");
      out.write("                            </div>\n");
      ...
      out.write("\n");
      out.write("                                    <input value=\"");
      out.print(product.getProductRequest().getPrice());
      out.write("\" type=\"text\" class=\"form-control\" name=\"rprice\" onkeypress=\"return isNumber(event)\"/>\n");
      out.write("\n");
      ...
      out.write("                                    ");
                                        ...
                                        for (ProductSize size : psl) {
                                    
      out.write("\n");
      out.write("                                    <input type=\"checkbox\" class=\"form-group\" name=\"rsize\" value=\"");
      out.print( size.getId());
      out.write('"');
      out.write(' ');
      out.print( sizeValues.contains(size.getId() + "") ? "checked" : "");
      out.write('/');
      out.write('>');
      ...
      out.write("                                    ");
                                        ...
                                        for (ProductColour coo : colo) {
                                    
      out.write("\n");
      out.write("                                    <input type=\"checkbox\" class=\"form-group\" name=\"rcolour\" value=\"");
      out.print( coo.getId());
      out.write('"');
      out.write(' ');
      out.print( colourValues.contains(coo.getId() + "") ? "checked" : "");
      out.write(">\n");
      out.write("                                    ");
