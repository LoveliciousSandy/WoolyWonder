...
public final class category_purewhite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    ");
                        ...
                        String sql1 = "SELECT * FROM `product_category` JOIN `product` ON `product`.`category`=`product_category`.`id` WHERE `product_category`.`id`=4";
      ...
      out.write("\n");
      out.write("<!--                    \n");
      out.write("-->                <div class=\" container col-sm-9\"><!--ww\n");
      out.write("-->                    <div class=\"row\">\n");
