    ...
    <body>
        ...
        <div class= container-fluid" id="f">
            <div class="wel well-lg">
                ...
                <h2 style="margin-left: 60px;">My Recent Orders</h2>
            </div>
        </div>
        <br><br>
        <br>
                    ...
                    <table class="table table-hover" id="tableproduct">
                        ...
                        <tbody>
                            <tr style="height: 50px;">
                                ...
                                <td>
                                    <h5><strong><%= (e.getTotal() + e.getShipping())%></strong></h5>
                                </td>
                                <td>
                                ...
                                <td>
                                    <button class="btn btn-success" <%= o.getStatus().equals("Shipped") ? "" : "disabled"%> onclick="Delivered(<%= o.getId()%>);">Delivered</button>
                                </td>
                            </tr>
                        </tbody>
                        <% }
            ...
            function Delivered(oid) {
                ...
                r1.onreadystatechange = function () {
                    if (r1.readyState === 4 && r1.status === 200) {
                        if (r1.responseText == "msg=3") {
                            location.reload();
                        }
                    }
                };
                r1.open("GET", "status?D=0&orderid=" + oid, true);
                r1.send();
