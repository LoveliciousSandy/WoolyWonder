    ...
    <body>
        ...
        <div class= container-fluid" id="f">
            <div class="wel well-lg">
                <h2 style="margin-left: 60px;">Product Update</h2>
            </div>
        </div><br>
        <form action="../update_product" method="POST" enctype="multipart/form-data">
            <input type="hidden" style="display:none" value="<%= product.getId()%>" name="update"/>
                    ...
                    <div class="tab-content">
                        <div id="General" class="tab-pane fade in active"><br><br>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="pcategory" name="pcategory" onchange="getproductsub();">
                                        ...
                                        <option value="<%= pcat.getId()%>"<%=product.getProductCategory().getId() != null && product.getProductCategory().getId().equals(pcat.getId()) ? "selected" : ""%>><%= pcat.getName()%></option>
                                        <% } %>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="psubcategory" name="psubcategory">
                                        ...
                                        <option value="<%= c.getId()%>" <%=product.getProductSubcategory().getId() != null && product.getProductSubcategory().getId().equals(c.getId()) ? "selected" : ""%>><%= c.getSubcategory()%></option>
                                        <%
                                                }
                                            }
                                        %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="pname" id="pname" required="" onkeypress="return isAlfa(event)" value="<%= product.getName()%>" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"> 
                                    <select class="form-control" name="pcolour">
                                        ...
                                        %>
                                        <option value="<%= colour.getId()%>" <%=product.getProductColour().getId() != null && product.getProductColour().getId().equals(colour.getId()) ? "selected" : ""%>><%= colour.getName()%></option>  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"> 
                                    <select class="form-control" id="psize" name="psize">
                                        ...
                                        %>
                                        <option value="<%= psize.getId()%>" <%=product.getProductSize().getId() != null && product.getProductSize().getId().equals(psize.getId()) ? "selected" : ""%>><%= psize.getName()%></option>  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"> 
                                    <input type="number" class="form-control" name="pqty" value="<%=product.getQty()%>" min="0">
                                </div>
                            </div>
                            <br>
                            <br>
                        ...
                        <div id="Cost" class="tab-pane fade"><br><br>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"> 
                                    <input value="<%=product.getPrice()%>" type="text" class="form-control" placeholder="0.00" name="pprice" onkeypress="return isNumber(event)"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"> 
                                    <input value="<%=product.getShipping()%>" type="text" class="form-control" placeholder="0.00" name="pshipping" onkeypress="return isNumber(event)"/>
                        ...
                        <div id="Request" class="tab-pane fade">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea  id="textarea" class="form-control" rows="4" name="rdescription"><%=product.getProductRequest().getDescription()%></textarea>
                                </div>
                            </div>
                            <br><br><br><br><br>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4"> 
                                    ...
                                    <input value="<%=product.getProductRequest().getPrice()%>" type="text" class="form-control" name="rprice" onkeypress="return isNumber(event)"/>
